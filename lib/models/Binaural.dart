...
class BinauralPage extends StatefulWidget {
  ...
  @override
  State<BinauralPage> createState() => _BinauralPageState();
}

class _BinauralPageState extends State<BinauralPage> {
  late AudioPlayer _audioPlayer;
  bool isPlaying = false;
  String? currentlyPlayingSound;
  String selectedCategory = 'Binaural Beats';
  ...
  void _playSound(String soundName) async {
    ...
    await _audioPlayer.setAsset('assets/binaural/$fileName.mp3');
    await _audioPlayer.play();
  }
